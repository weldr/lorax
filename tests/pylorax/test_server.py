    ...
    def test_03_blueprints_info(self):
        ...
        info_dict_2 = {"changes":[{"changed":False, "name":"example-glusterfs"},
                       ...
                       "blueprints":[{"description": "An example GlusterFS server with samba",
                                   "modules":[{"name":"glusterfs", "version":"6.*"},
                                              {"name":"glusterfs-cli", "version":"6.*"}],
...
class RepoCacheTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        server.config["YUMLOCK"] = YumLock(server.config["COMPOSER_CFG"], expire_secs = 10)
    ...
    def test_metadata_expires(self):
        """Ensure that metadata expire settings pick up changes to the repo when expected"""
