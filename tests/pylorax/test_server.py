...
class ServerTestCase(unittest.TestCase):
    ...
    def test_compose_02_bad_type(self):
        ...
        self.assertEqual(data["errors"], [{"id": BAD_COMPOSE_TYPE, "msg": "Invalid compose type (snakes), must be one of ['ext4-filesystem', 'live-iso', 'partitioned-disk', 'qcow2', 'tar', 'vmdk']"}],
