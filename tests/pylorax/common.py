...
class ServerCommon(unittest.TestCase):
    """Common API route testing"""
    jwt_header = {}
    server = None
    examples_path = ""

    # Keep nosetest from loading this without it being subclassed by something that sets it True
    __test__ = False

    def get(self, *args, **kwargs):
        """Add JWT Authentication header, if present"""
        kwargs["headers"] = self.jwt_header
        return self.server.get(*args, **kwargs)

    def post(self, *args, **kwargs):
        """Add JWT Authentication header, if present"""
        kwargs["headers"] = self.jwt_header
        return self.server.post(*args, **kwargs)

    def delete(self, *args, **kwargs):
        """Add JWT Authentication header, if present"""
        kwargs["headers"] = self.jwt_header
        return self.server.delete(*args, **kwargs)

    def test_01_status(self):
        """Test the /api/v0/status route"""
        status_dict = {"build":"devel", "api":"0", "db_version":"0", "schema_version":"0", "db_supported":False}
        resp = self.get("/api/v0/status")
    ...
    def test_02_recipes_list(self):
        ...
        resp = self.get("/api/v0/recipes/list")
        data = json.loads(resp.data)
    ...
    def test_03_recipes_info(self):
        ...
        info_dict_1 = {"changes":[{"changed":False, "name":"http-server"}],
                       ...
                       "recipes":[{"description":"An example http server with PHP and MySQL support.",
                                   ...
                                   "version": "0.0.1"}]}
        resp = self.get("/api/v0/recipes/info/http-server")
        data = json.loads(resp.data)
        ...
        resp = self.get("/api/v0/recipes/info/http-server,glusterfs")
        data = json.loads(resp.data)
    ...
    def test_05_recipes_new_json(self):
        ...
        resp = self.post("/api/v0/recipes/new",
                                data=json.dumps(test_recipe),
                                content_type="application/json")
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})

        resp = self.get("/api/v0/recipes/info/glusterfs")
        data = json.loads(resp.data)
    ...
    def test_07_recipes_ws_json(self):
        ...
        resp = self.post("/api/v0/recipes/workspace",
                                data=json.dumps(test_recipe),
                                content_type="application/json")
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})
    ...
    def test_09_recipes_ws_delete(self):
        ...
        # Delete it
        resp = self.delete("/api/v0/recipes/workspace/glusterfs")
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})
    ...
    def test_10_recipes_delete(self):
        ...
        resp = self.delete("/api/v0/recipes/delete/glusterfs")
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})
    ...
    def test_11_recipes_undo(self):
        ...
        resp = self.get("/api/v0/recipes/changes/glusterfs")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        ...
        resp = self.post("/api/v0/recipes/undo/glusterfs/%s" % commit)
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})
    ...
    def test_12_recipes_tag(self):
        ...
        resp = self.post("/api/v0/recipes/tag/glusterfs")
        data = json.loads(resp.data)
        self.assertEqual(data, {"status":True})
    ...
    def test_13_recipes_diff(self):
        ...
        resp = self.get("/api/v0/recipes/diff/glusterfs/%s/%s" % (from_commit, to_commit))
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        ...
        resp = self.get("/api/v0/recipes/diff/glusterfs/NEWEST/WORKSPACE")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        print(data)
    ...
    def test_14_recipes_depsolve(self):
        ...
        resp = self.get("/api/v0/recipes/depsolve/glusterfs")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        recipes = data.get("recipes")
        self.assertNotEqual(recipes, None)
    ...
    def test_14_recipes_depsolve_empty(self):
        ...
        resp = self.get("/api/v0/recipes/depsolve/void")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        recipes = data.get("recipes")
        self.assertNotEqual(recipes, None)
    ...
    def test_15_recipes_freeze(self):
        ...
        resp = self.get("/api/v0/recipes/freeze/glusterfs")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        recipes = data.get("recipes")
        self.assertNotEqual(recipes, None)
    ...
    def test_projects_list(self):
        ...
        resp = self.get("/api/v0/projects/list")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
    ...
    def test_projects_info(self):
        ...
        resp = self.get("/api/v0/projects/info/bash")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        projects = data.get("projects")
    ...
    def test_projects_depsolve(self):
        ...
        resp = self.get("/api/v0/projects/depsolve/bash")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
    ...
    def test_modules_list(self):
        ...
        resp = self.get("/api/v0/modules/list")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        print(data)
        ...
        resp = self.get("/api/v0/modules/list/d*")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        print(data)
        modules = data.get("modules")
    ...
    def test_modules_info(self):
        ...
        resp = self.get("/api/v0/modules/info/bash")
        data = json.loads(resp.data)
        self.assertNotEqual(data, None)
        modules = data.get("modules")
